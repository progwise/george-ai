...
const outputSchema = z.object({
  ...
  source: z
    .string()
    .describe(
      'Indicates the origin of the final answer using a single word. Use "local" if the answer is derived from the local context, "web" if it is retrieved from a web source, or "model" if it is solely generated by the language model.',
    ),
