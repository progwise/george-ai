...
export default interface PrismaTypes {
  ...
  AiLibrary: {
    ...
    RelationName:
      ...
      | 'listSources'
      | 'modelUsageLogs'
    ListRelations: 'crawlers' | 'files' | 'updates' | 'usages' | 'listSources' | 'modelUsageLogs'
    Relations: {
      embeddingModel: {
        Shape: AiLanguageModel | null
        Name: 'AiLanguageModel'
  ...
  AiLibraryFile: {
    ...
    Create: {}
    Update: {}
    RelationName: 'crawledByCrawler' | 'library' | 'updates' | 'listItems' | 'fileUploads'
    ListRelations: 'updates' | 'listItems' | 'fileUploads'
    Relations: {
      crawledByCrawler: {
  ...
  FileUploads: {
    Name: 'FileUploads'
    Shape: FileUploads
    Include: Prisma.FileUploadsInclude
    Select: Prisma.FileUploadsSelect
    OrderBy: Prisma.FileUploadsOrderByWithRelationInput
    WhereUnique: Prisma.FileUploadsWhereUniqueInput
  ...
  AiList: {
    ...
    Create: {}
    Update: {}
    RelationName: 'enrichmentTasks' | 'workspace' | 'fields' | 'sources' | 'items' | 'modelUsageLogs' | 'automations'
  ...
  AiListItem: {
    ...
    Create: {}
    Update: {}
    RelationName: 'list' | 'source' | 'file' | 'cache' | 'enrichmentTasks' | 'automationItems'
  ...
  AiModelUsage: {
    ...
    Create: {}
    Update: {}
    RelationName: 'assistant' | 'library' | 'list' | 'model'
    ListRelations: never
    Relations: {
      assistant: {
        Shape: AiAssistant | null
