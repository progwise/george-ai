...
export default interface PrismaTypes {
  ...
  AiLibraryFile: {
    ...
    Create: {}
    Update: {}
    RelationName: 'crawledByCrawler' | 'library' | 'updates' | 'listItems'
    ListRelations: 'updates' | 'listItems'
    Relations: {
      crawledByCrawler: {
