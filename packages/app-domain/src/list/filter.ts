...
export const LIST_FILTER_TYPE_VALUES = [
  'equals',
  'not_equals',
  'contains',
  'not_contains',
...
export type ListFilterType = (typeof LIST_FILTER_TYPE_VALUES)[number]

const getFieldPropertyFilterExpression = (filter: { filterType: ListFilterType; value: string }) => {
...
const getItemPropertyFilterWhere = (
  ...
  filter: { filterType: ListFilterType; value: string },
