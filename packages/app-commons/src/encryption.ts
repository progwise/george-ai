 ...
 */
export function encryptValue(plaintext: undefined): undefined
export function encryptValue(plaintext: null): undefined
export function encryptValue(plaintext: null | undefined): undefined
