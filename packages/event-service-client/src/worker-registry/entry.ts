...
export async function deleteWorkerRegistryEntry(workerId: string): Promise<void> {
  await eventClient.delete({ bucketName: WORKER_REGISTRY_BUCKET_NAME, key: workerId })
}
