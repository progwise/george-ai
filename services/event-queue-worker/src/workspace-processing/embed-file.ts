...
//   const { workspaceId, libraryId, documentId, embeddingDriver, embeddingModel, splitMethod } = event
...
//   const chunkStream = readChunks({ workspaceId, libraryId, fileId: documentId })
