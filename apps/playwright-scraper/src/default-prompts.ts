export const defaultPrompts = {
  de: {
    summary: [
      'Gib mir eine Zusammenfassung der Angebote in maximal 300 Worten, in Deutsch, für den folgenden Textinhalt einer Website. Erwähne Ansprechpartner und Kontaktinformationen und nutze HTML-Tags wie <h3>, <p> und <ul> für eine bessere Formatierung.',
      'Stelle sicher, dass die Zusammenfassung in Deusch ist',
  ...
  en: {
    summary: [
      'Provide a summary of the offerings in a maximum of 300 words, in englisch, for the following website content. Mention contact persons and contact information, and use HTML tags like <h3>, <p>, and <ul> for better formatting.',
      'Make sure that the summary is in English',
