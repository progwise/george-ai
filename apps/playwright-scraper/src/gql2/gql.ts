 ...
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(source: "mutation CreateWebPageSummary($data: WebPageSummaryInput!, $locale: I18NLocaleCode!) {\n  createWebPageSummary(data: $data, locale: $locale) {\n    data {\n      id\n      attributes {\n        Title\n        Url\n        LargeLanguageModel\n        OriginalContent\n        GeneratedSummary\n        GeneratedKeywords\n      }\n    }\n  }\n}"): (typeof documents)["mutation CreateWebPageSummary($data: WebPageSummaryInput!, $locale: I18NLocaleCode!) {\n  createWebPageSummary(data: $data, locale: $locale) {\n    data {\n      id\n      attributes {\n        Title\n        Url\n        LargeLanguageModel\n        OriginalContent\n        GeneratedSummary\n        GeneratedKeywords\n      }\n    }\n  }\n}"];
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
