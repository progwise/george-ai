...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Split a JSONL dataset into train/valid/test sets.")
    parser.add_argument("input_file", help="Path to the input JSONL file.")
    parser.add_argument("--output", default="split_output", help="Directory to save the split files.")
    parser.add_argument("--train", type=float, default=0.8, help="Proportion for training set.")
    parser.add_argument("--valid", type=float, default=0.1, help="Proportion for validation set.")
