...
The server builds and starts automatically on port 11245 when starting the dev container. If you do not need to change the crawler server you can just use it.
