export default {
  actions: {
    ...
    details: 'Details',
    drop: 'Drop',
    dropSuccess: '{count} file/s dropped successfully',
    edit: 'Edit',
    ...
    reProcessSuccess: 'Re-processed successfully',
    save: 'Save',
    saving: 'Saving...',
  ...
  errors: {
    ...
    dropFilesError: 'An error occurred while dropping the files. Please try again later.',
  ...
  texts: {
    ...
    numberOfFilesToBeDropped: '{count} file(s) were/was successfully dropped.',
  ...
  tooltips: {
    ...
    delete: 'Delete',
    deleteMessage: 'Delete message',
    dropDescription: 'Delete selected files',
    edit: 'Edit',
    hide: 'Hide',
