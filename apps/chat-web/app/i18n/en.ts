export default {
  ...
  libraries: {
    ...
    deleteAllUpdates: 'Delete all updates',
    deleteAllUpdatesDescription: 'This action deletes all files from this library. Files remain unaffected.',
    deleteAllUpdatesFailed: 'Failed deleting all updates from library.',
    deleteAllUpdatesSuccess: '{count} updates successfully deleted.',
  ...
  tooltips: {
    ...
    delete: 'Delete',
    deleteAllUpdates: 'Deletes all updates',
    deleteMessage: 'Delete message',
