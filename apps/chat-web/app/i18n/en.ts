export default {
  ...
  texts: {
    ...
    processUnprocessed:
      "You are about to process all pending and failed files. This action may take some while. Do you want to continue? Please confirm by pressing the 'Process all' button.",
  ...
  tooltips: {
    ...
    processUnprocessed: 'Processes unprocessed and failed files',
