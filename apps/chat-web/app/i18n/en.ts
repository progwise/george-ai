export default {
  ...
  errors: {
    ...
    dropFile: 'An error occurred while dropping the file {file}: {error}.',
    ...
    reprocessFileError: 'An error occurred while reprocessing the file: {error}',
    reprocessFilesError: 'An error occurred while processing {count} files: {files}.',
