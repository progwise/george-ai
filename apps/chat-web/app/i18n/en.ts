export default {
  actions: {
    ...
    noNewFilesToProcess: 'All files are already being processed.',
  ...
  errors: {
    ...
    processUnprocessed: 'An error occured while processing unprocessed files.',
  ...
  texts: {
    ...
    noFilesInQueue: 'There are no files in queue.',
    noUnprocessedFiles: 'Cannot find any unprocessed files in this library.',
    noUsersAvailable: 'No users available',
    noUsersFound: 'No users found',
    noUsersMatchFilters: 'No users match your filters',
    numberOfConversationsToRemove: ' conversation(s) will be removed.',
    numberOfFilesInQueue: 'There are currently {count} files being processed.',
  ...
  tooltips: {
    ...
    processUnprocessed: 'Processes unprocessed files',
