export default {
  actions: {
    ...
    leave: 'Verlassen',
    processUnprocessed: 'Dateien verarbeiten',
  ...
  libraries: {
    ...
    processUnprocessed: 'Offene Dateien verarbeiten',
  ...
  texts: {
    ...
    processUnprocessed:
      'Sie sind dabei, alle offenen sowie fehlgeschlagenen Dateien zu verarbeiten. Dieser Vorgang kann einige Zeit in Anspruch nehmen. Bitte bestätigen Sie das Verarbeiten der Dateien, indem Sie auf die Fläche „Dateien verarbeiten" klicken.',
  ...
  tooltips: {
    ...
    processUnprocessed: 'Verarbeitet offene Dateien',
