export default {
  actions: {
    ...
    noNewFilesToProcess: 'Alle Dateien befinden sich bereits in der Warteschlange.',
    leave: 'Verlassen',
  ...
  errors: {
    ...
    processUnprocessed: 'Beim Verarbeiten Ihrer Dateien ist ein Fehler aufgetreten.',
  ...
  texts: {
    ...
    noFilesInQueue: 'Es wurden keine Dateien in der Warteschlange gefunden.',
    noUnprocessedFiles: 'Es konnten keine unverarbeiteten Dateien in dieser Bibliothek gefunden werden.',
    ...
    numberOfFilesInQueue: 'Derzeit befinden sich {count} Dateien in der Warteschlange.',
  ...
  tooltips: {
    ...
    processUnprocessed: 'Verarbeitet unverarbeitete Dateien',
