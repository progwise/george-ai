export default {
  ...
  libraries: {
    ...
    deleteAllUpdates: 'Alle Updates löschen',
    deleteAllUpdatesDescription: 'Diese Aktion löscht alle Updates aus dieser Bibliothek. Dateien bleiben unberührt.',
    deleteAllUpdatesFailed: 'Löschen aller Updates fehlgeschlagen.',
    deleteAllUpdatesSuccess: '{count} Updates erfolgreich gelöscht.',
  ...
  tooltips: {
    ...
    delete: 'Löschen',
    deleteAllUpdates: 'Löscht alle Updates',
    deleteMessage: 'Nachricht löschen',
