export default {
  ...
  texts: {
    ...
    noUnprocessedFiles:
      'Alle Dateien in dieser Biblithek sind verarbeitet oder Dateien sind derzeit in der Verarbeitung. Bitte versuchen Sie es in einigen Minuten nochmals, falls Ihre Dateien nicht verarbeitet sein sollten.',
    ...
    processUnprocessed:
      'Sie sind dabei, alle unverarbeiteten sowie fehlgeschlagenen Dateien zu verarbeiten. Dieser Vorgang kann einige Zeit in Anspruch nehmen. Bitte bestätigen Sie das Verarbeiten der Dateien, indem Sie auf die Fläche „Dateien verarbeiten" klicken.',
  ...
  tooltips: {
    ...
    processUnprocessed: 'Verarbeitet unverarbeitete und fehlgeschlagene Dateien',
