...
const documents: Documents = {
  ...
  '\n        query GetContentExtractionTasks(\n          $libraryId: String!\n          $fileId: String\n          $status: ProcessingStatus\n          $skip: Int\n          $take: Int\n        ) {\n          aiContentExtractionTasks(libraryId: $libraryId, fileId: $fileId, status: $status, skip: $skip, take: $take) {\n            count\n            tasks {\n              ...AiContentExtractionTask_AccordionItem\n            }\n          }\n        }\n      ':
    types.GetContentExtractionTasksDocument,
  '\n  fragment AiContentExtractionTask_AccordionItem on AiFileContentExtractionTask {\n    id\n    ...AiContentExtractionTask_Timeline\n    file {\n      id\n      name\n    }\n    createdAt\n    extractionMethod\n    timeoutMs\n    markdownFileName\n    metadata\n    extractionOptions\n    extractionStatus\n    embeddingStatus\n    processingTimeMs\n    processingStatus\n    chunksCount\n    chunksSize\n    ...AiContentExtractionTask_Timeline\n  }\n':
    types.AiContentExtractionTask_AccordionItemFragmentDoc,
  '\n  fragment AiContentExtractionTask_Timeline on AiFileContentExtractionTask {\n    extractionMethod\n    createdAt\n    processingStartedAt\n    processingFinishedAt\n    processingFailedAt\n    processingTimeout\n    extractionStartedAt\n    extractionFinishedAt\n    extractionFailedAt\n    extractionTimeMs\n    extractionTimeout\n    embeddingStartedAt\n    embeddingFinishedAt\n    embeddingFailedAt\n    embeddingTimeMs\n    embeddingTimeout\n    embeddingModelName\n  }\n':
    types.AiContentExtractionTask_TimelineFragmentDoc,
  '\n  mutation changeLibrary($id: String!, $data: AiLibraryInput!) {\n    updateLibrary(id: $id, data: $data) {\n      ...AiLibraryDetail\n    }\n  }\n':
