...
export const RiskAreasIdentification = (props: RiskAreasIdentificationProps) => {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-4 rounded-lg bg-base-100 p-4 shadow">
      <div className="text-xl font-bold">{identifyRiskInfo.title[language]}</div>
      ...
      <div className={`flex flex-col gap-2 rounded-lg border p-4 ${getRiskStyle()}`}>
        <div className="text-lg font-semibold">{t('aiAct.summaryInitialAssessment')}</div>
      ...
      <div className="rounded-lg border bg-base-200 p-4">
        <div className="text-md mb-3 font-semibold">{t('aiAct.systemProperties')}</div>
