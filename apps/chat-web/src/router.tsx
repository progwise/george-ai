...
function DefaultErrorComponent({ error }: { error: Error }) {
  ...
  return (
    <div className="bg-base-200 flex items-center justify-center p-4">
      <div className="bg-base-100 w-full rounded-lg p-6 shadow-xl">
        <div className="mb-4 flex items-start gap-4">
          <ErrorIcon className="text-error size-8" />
          <div className="flex-1">
            <h1 className="text-error text-2xl font-bold">Oops! Something went wrong</h1>
            <p className="text-base-content/70 mt-2">An unexpected error occurred while loading this page.</p>
          </div>
        </div>

        <div className="bg-error/10 mb-4 rounded-md p-4">
        ...
        {showDetails && (
          <div className="bg-base-200 mb-4 max-h-96 overflow-auto rounded-md p-4">
