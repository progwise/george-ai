export default {
  ...
  admin: {
    ...
    manageWorkersLabel: 'Workers Overview',
    ...
    workers: {
      ...
      extractionRequests: 'Extraction Requests',
      healthy: 'Healthy',
      lastHeartbeat: 'Last Heartbeat',
      noActiveWorkers: 'No active workers',
      noStatisticsAvailable: 'No statistics available',
      noWorkspaceStatistics: 'No workspace statistics available',
      offline: 'Offline',
      pending: 'Pending',
      processed: 'Processed',
  ...
  crawlers: {
    ...
    excludePatterns: 'Exclude Patterns (glob patterns: *, ?, **, comma-separated)',
    excludePatternsHelp: 'Glob patterns to exclude files. Examples: *.tmp, **/temp/**, .git/**',
    filtersActive: 'Enable File Filters',
    includePatterns: 'Include Patterns (glob patterns: *, ?, **, comma-separated)',
    includePatternsHelp: 'Glob patterns to include files. Examples: *.pdf, **/*.docx, data/**',
    lastRun: 'Last Run',
    maxDepth: 'Depth',
  ...
  errors: {
    ...
    paginationMissing: 'Pagination missing',
  ...
  files: {
    ...
    processingTasks: 'Processing Tasks for file ',
  ...
  labels: {
    actions: 'Actions',
    activeExtractions: 'Active Extractions ',
    activated: 'Activated',
    activatedAt: 'Activated at',
    adminProfileActivation: 'Admin Profile Activation',
    allCrawlers: 'All crawlers',
    allUsers: 'All Users',
    archived: 'Archived',
  ...
  libraries: {
    ...
    lastSequence: 'Last sequence: {last}',
    lastUpdate: 'Last update',
    ...
    processingTasks: 'Processing tasks for library ',
    querySearch: 'matches for your search term: ',
    ...
    title: 'Library',
    totalRequests: 'Total Requests: {total}',
  ...
  sidebar: {
    ...
    copyItemLinkSuccess: 'Link copied successfully.',
    deleteItem: 'Delete',
    libraries: 'Libraries',
    lists: 'Lists',
    open: 'Open sidebar',
  ...
  workspace: {
    ...
    contactAdmin: 'Please contact your workspace administrator.',
    ...
    current: 'Workspace: ',
    deleteBlockedAutomations: '{count} automations',
    deleteBlockedDescription: 'This workspace cannot be deleted because it contains items.',
    deleteBlockedItems: 'Delete {count} blocked elements first',
    deleteBlockedLists: '{count} lists',
