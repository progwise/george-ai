export default {
  actions: {
    ...
    close: 'Close',
    confirm: 'Confirm',
    confirmDeleteFeedback: 'Click again to confirm',
    create: 'Create',
    ...
    deleteSuggestedAnswer: 'Delete answer suggestion',
    details: 'Details',
    drop: 'Drop',
  ...
  conversations: {
    ...
    createNegativeFeedbackTitel: 'Negative feedback',
    createPositiveFeedbackTitel: 'Positive feedback',
    ...
    editFeedbackTitel: 'Edit feedback',
    editSuggestedAnswerTitel: 'Edit suggested alternative answer',
  ...
  errors: {
    ...
    changeFeedbackSuggestion: 'An error occured while changing the alternative answer suggestion',
    copyFailed: 'Copy failed',
    createExtractionTasks: 'Failed to create extraction tasks: {error}',
    createFeedback: 'An error occured while creating feedback',
    deleteFeedback: 'An error occured while deleting feedback',
    deleteFeedbackSuggestion: 'An error occured while deleting the alternative answer suggestion',
    ...
    updateFeedback: 'An error occured while changing the feedback: {error}',
  ...
  labels: {
    ...
    allUsers: 'All Users',
    alternativeAnswerSuggestion: 'Alternative answer suggestion (optional)',
    archived: 'Archived',
    assistant: 'Assistant',
  ...
  notifications: {
    ...
    feedbackChanged: 'Feedback changed successfully',
  ...
  texts: {
    ...
    createFeedbackDescription:
      'You are about to give feedback. Be aware that you can delete the feedback or the alternative answer suggestion only when the corresponding message, the conversation and your user profile still exist. By submitting the feedback you agree to this condition.',
    ...
    editFeedbackDescription:
      'You are about to change feedback. Be aware that you can delete the feedback or the alternative answer suggestion only when the corresponding message, the conversation and your user profile still exist. By submitting the feedback you agree to this condition.',
    editSuggestedAnswerDescription:
      'You are about to change the alternative answer suggestion. Be aware that you can delete the alternative answer suggestion only when the corresponding message, the conversation and your user profile still exist. By submitting the answer suggestion you agree to this condition.',
  ...
  tooltips: {
    ...
    edit: 'Edit',
    giveNegativeFeedback: 'Give negative feedback',
    givePositiveFeedback: 'Give positive feedback',
    hide: 'Hide',
