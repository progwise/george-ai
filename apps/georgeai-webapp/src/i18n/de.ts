export default {
  actions: {
    ...
    close: 'Schließen',
    confirm: 'Bestätigen',
    confirmDeleteFeedback: 'Zum Bestätigen erneut klicken',
    create: 'Erstellen',
    ...
    deleteSuggestedAnswer: 'Antwortvorschlag löschen',
    details: 'Details',
    drop: 'Entfernen',
  ...
  conversations: {
    ...
    createNegativeFeedbackTitel: 'Negatives Feedback',
    createPositiveFeedbackTitel: 'Positives Feedback',
    ...
    editFeedbackTitel: 'Feedback bearbeiten',
    editSuggestedAnswerTitel: 'Alternativen Antwortvorschlag bearbeiten',
  ...
  errors: {
    ...
    changeFeedbackSuggestion: 'Fehler beim Ändern des verbesserten Antwortvorschlags',
    copyFailed: 'Kopieren fehlgeschlagen',
    createExtractionTasks: 'Fehler beim Erstellen von Extraktions-Tasks: {error}',
    createFeedback: 'Fehler beim Erstellen von Feedback',
    deleteFeedback: 'Fehler beim Löschen von Feedback',
    deleteFeedbackSuggestion: 'Fehler beim Löschen des verbesserten Antwortvorschlags',
    ...
    updateFeedback: 'Fehler beim Erstellen von Feedback: {error}',
  ...
  labels: {
    ...
    alternativeAnswerSuggestion: 'Alternativer Antwortvorschlag (optional)',
    archived: 'Archiviert',
    assistant: 'Assistent',
  ...
  notifications: {
    ...
    feedbackChanged: 'Feedback erfolgreich geändert',
    feedbackCreated: 'Feedback erfolgreich erstellt',
  ...
  texts: {
    ...
    createFeedbackDescription:
      'Sie sind dabei, Feedback zu erstellen. Seien Sie sich bewusst, dass Feedback und verbesserte Antwortvorschläge nur dann wieder gelöscht werden können, wenn die dazu gehörige Nachricht und Konversation sowie Ihr Benutzerprofil noch existieren. Durch Senden des Feedbacks stimmen Sie dieser Bedingung zu.',
    ...
    editFeedbackDescription:
      'Sie sind dabei, Feedback zu verändern. Seien Sie sich bewusst, dass Feedback und verbesserte Antwortvorschläge nur dann wieder gelöscht werden können, wenn die dazu gehörige Nachricht und Konversation sowie Ihr Benutzerprofil noch existieren. Durch Senden des Feedbacks stimmen Sie dieser Bedingung zu.',
    editSuggestedAnswerDescription:
      'Sie sind dabei, den alternativen Antwortvorschlag zu ändern. Seien Sie sich bewusst, dass erbesserte Antwortvorschläge nur dann wieder gelöscht werden können, wenn die dazu gehörige Nachricht und Konversation und Ihr Benutzerprofil noch existieren. Durch Senden des Antwortvorschlags stimmen Sie dieser Bedingung zu.',
  ...
  tooltips: {
    ...
    edit: 'Bearbeiten',
    giveNegativeFeedback: 'Negatives Feedback geben',
    givePositiveFeedback: 'Positives Feedback geben',
    hide: 'Verbergen',
