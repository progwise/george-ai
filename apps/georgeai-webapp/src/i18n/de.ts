export default {
  ...
  admin: {
    ...
    manageWorkersDescription: 'Arbeits-Prozesse anzeigen und den Verarbeitungsstatus für jeden Workspace überwachen.',
    monitorAiServices: 'AI-Dienste',
    ...
    workers: {
      ...
      embeddingFinished: 'Embedding abgeschlossen',
      embeddingProgress: 'Embedding-Fortschritt',
      embeddingRequests: 'Embedding-Anfragen',
      eventStatistics: 'Event-Statistiken',
      extractionRequests: 'Extraktionsanfragen',
      healthy: 'Gesund',
      lastHeartbeat: 'Letzter Heartbeat',
      noActiveWorkers: 'Keine aktiven Worker',
      noStatisticsAvailable: 'Keine Statistiken verfügbar',
      noWorkspaceStatistics: 'Keine Workspace-Statistiken verfügbar',
      offline: 'Offline',
      pending: 'Ausstehend',
      processed: 'Verarbeitet',
      processingType: 'Verarbeitungstyp',
      startEmbedding: 'Starte Embedding',
      stopEmbedding: 'Beende Embedding',
      startExtraction: 'Starte Extraction',
      stopExtraction: 'Beende Extraction',
      startEnrichment: 'Starte Enrichment',
      stopEnrichment: 'Beende Enrichment',
      ...
      workspaceStatistics: 'Workspace-Statistiken',
    },
  },
  aiAct: {
    applicableHeadline:
  ...
  crawlers: {
    ...
    excludePatterns: 'Ausschlussmuster (Glob-Muster: *, ?, **, kommagetrennt)',
    excludePatternsHelp: 'Glob-Muster zum Ausschließen von Dateien. Beispiele: *.tmp, **/temp/**, .git/**',
    filtersActive: 'Dateifilter aktivieren',
    includePatterns: 'Einschlussmuster (Glob-Muster: *, ?, **, kommagetrennt)',
    includePatternsHelp: 'Glob-Muster zum Einschließen von Dateien. Beispiele: *.pdf, **/*.docx, data/**',
  ...
  errors: {
    ...
    paginationMissing: 'Pagination fehlt',
  ...
  extractionMethods: {
    default: 'Standard Extraktion',
    pdfExtraction: 'PDF Extraktion',
    textExtraction: 'Text Extraktion',
    excelExtraction: 'Excel Extraktion',
    ocr: 'OCR Extraktion',
    text: 'Text Extraktion',
  },
  files: {
    ...
    processingTasks: 'Verarbeite Aufgaben für Datei ',
  ...
  labels: {
    ...
    lastReconcile: 'Letzte Synchronisierung',
  ...
  libraries: {
    ...
    lastSequence: 'Letzte Sequenz: {last}',
    ...
    processingTasks: 'Verarbeite Aufgaben für Bibliothek ',
    querySearch: 'Treffer für Ihren Suchbegriff: ',
    ...
    timestamp: 'Zeitstempel {stamp}',
    title: 'Bibliothek',
    totalRequests: 'Anfragen insgesamt: {total}',
    upgradeFromLegacy: 'Legacy-Bibliothek upgraden',
  },
  lists: {
    contextSources: {
      ...
      fullContentDescription: 'Den vollständigen Markdown-Inhalt aus der Quelldatei als Kontext einbeziehen',
      fullContentDisabled: 'Vollständiger Inhaltskontext ist deaktiviert',
      fullContentHelp:
        'Den gesamten Inhalt der Quelldatei als Kontext einbeziehen. Dies bietet die vollständigsten Informationen, kann aber bei großen Dateien die Token-Limits überschreiten.',
      fullContentMaxTokens: 'Maximale Tokens für vollständigen Inhalt',
      fullContentTokensHelp: 'Große Dateien werden gekürzt, um innerhalb dieses Limits zu bleiben',
      includeFullContent: 'Vollständigen Dateiinhalt als Kontext einbeziehen',
  ...
  workspace: {
    ...
    contactAdmin: 'Wenden Sie sich an den Admin Ihres Arbeitsbereichs.',
    createDescription:
    ...
    deleteBlockedAutomations: '{count} Automatisierung/en',
    deleteBlockedDescription: 'Dieser Arbeitsbereich kann nicht gelöscht werden, da er Elemente enthält.',
    deleteBlockedItems: '{count} gesperrte/s Element/e löschen',
    deleteBlockedLists: '{count} Liste/n',
    ...
    needsMigration: 'Benötigt Dateiumstellung',
    members: {
